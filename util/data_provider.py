...
def get_train_data_loaders(cap_files, visual_feats, vocab, bow2vec, batch_size=100, num_workers=0, n_caption=2, video2frames=None):
    """
...
def get_txt_data_loader(cap_file, vocab, bow2vec, batch_size=100, num_workers=0):
